var baSe64 = 'f6HnfV5tNrbcM6fedtR=',
    ...
    informasibatas = '<style>body{background:#000}#peringatan span{font-size:50px}#peringatan{z-index:' + '99999;position:fixed;top:0;right:0;left:' + '0;height:100%;text-align:center;background:rgba(0,' + ' 0, 0, 0.95);border:' + '5px solid #444;color' + ':#fff;padding:20px;font-family' + ':monospace;border-radius:10px}#peringatan h4{font-size:20px}' + '</style>,
