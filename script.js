var baSe64 = 'f6HnfV5tNr' + 'bcM6fedtR=',
    ...
    informasibatas = '<style>bod' + 'y{backgrou' + 'nd:#000}#p' + 'eringatan ' + 'span{font-' + 'size:50px}' + '#peringata' + 'n{z-index:' + '99999;posi' + 'tion:fixed' + ';top:0;rig' + 'ht:0;left:' + '0;height:1' + '00%;text-a' + 'lign:cente' + 'r;backgrou' + 'nd:rgba(0,' + ' 0, 0, 0.9' + '5);border:' + '5px solid ' + '#444;color' + ':#fff;padd' + 'ing:20px;f' + 'ont-family' + ':monospace' + ';border-ra' + 'dius:10px}' + '#peringata' + 'n h4{font-' + 'size:20px}' + '</style>',
